...
export class ProjMain extends Main{
    ...
    static inject(obj):any{
        switch (obj._category){
            case CONSTANTS.Config.PROJ_DESTINATION.LinkGeneralStructure:return new LinkGeneralStructure(obj);
            case CONSTANTS.Config.PROJ_DESTINATION.ModelStructure:return new ModelStructure(obj);
            case CONSTANTS.Config.PROJ_DESTINATION.OxiCamera:return new OxiCamera(obj);
            case CONSTANTS.Config.PROJ_DESTINATION.Vector3:return new Vector3(obj);
