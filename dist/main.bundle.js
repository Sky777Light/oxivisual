    ...
    SourceProject.prototype.create = function (form) {
        ...
        this.authService.post("/api/projects/project/model/create", myForm).subscribe(function (res) {
            ...
            if (res.status) {
                ...
                _this.project.model.data = [new __WEBPACK_IMPORTED_MODULE_2__entities_entities__["i" /* ModelStructure */](res.model.data)];
                ...
                if (res.status) {
                    ...
                    ['alignImages', 'images'].forEach(function (field) {
                        for (var f = 0; area[field] && f < area[field].length; f++) {
                            if (area[field][f] instanceof __WEBPACK_IMPORTED_MODULE_2__entities_entities__["h" /* ProjFile */] || area[field][f].file)
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "k", function() { return __WEBPACK_IMPORTED_MODULE_2__ModelStructure__["g"]; });
        ...
        function parseFiles(cur) {
            ...
            filereader.onloadend = function (e) {
                switch (cur.category) {
                    case __WEBPACK_IMPORTED_MODULE_1__entities_entities__["c" /* Config */].FILE.TYPE.MODEL_OBJ:
                        {
                            ...
                            loader.parse(e.currentTarget.result, function (m) {
                                _self.main.selected.destination = [new __WEBPACK_IMPORTED_MODULE_1__entities_entities__["h" /* ProjFile */]({ file: cur, name: cur.name })];
                    ...
                    case __WEBPACK_IMPORTED_MODULE_1__entities_entities__["c" /* Config */].FILE.TYPE.PREVIEW_IMG:
                        {
                            _self.main.selected.images.push(new __WEBPACK_IMPORTED_MODULE_1__entities_entities__["h" /* ProjFile */]({
                                file: cur,
                                name: cur.name,
                    ...
                    case __WEBPACK_IMPORTED_MODULE_1__entities_entities__["c" /* Config */].FILE.TYPE.ALIGN_IMG:
                        {
                            _self.main.selected.alignImages.push(new __WEBPACK_IMPORTED_MODULE_1__entities_entities__["h" /* ProjFile */]({
                                file: cur,
                                name: cur.name,
                                data: e.currentTarget.result
                            }));
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return ProjFile; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return GeneralStructure; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return LinkGeneralStructure; });
/* unused harmony export PCash */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return ModelStructure; });
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
    d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
