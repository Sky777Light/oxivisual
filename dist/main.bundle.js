...
var SVGView = (function () {
    ...
    SVGView.prototype.drawZoom = function (event) {
        ...
        if (!this.showHelpZoomer)
            return;
        var _deltaX = this.zoomDelta, _deltaY = _deltaX * this.curImgZoom.height / this.curImgZoom.width, zCnvs = this.zoomer['nativeElement'], _offset = event.e.currentTarget.getBoundingClientRect();
